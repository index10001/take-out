...
const formState = reactive({
  ...
  logo: storeStore.logo,
  phone: storeStore.phone,
  address: storeStore.address,
  businessHour: storeStore.businessHour,
  businessLicense: storeStore.businessLicense,
  description: storeStore.description,
  packagePrice: storeStore.packagePrice / 100,
  type: storeStore.type,
});
const rules = {
  name: [
    {
      ...
      .then(() => {
        axios.post(
          ...
          if (data.code === 200) {
            ...
            storeStore.id = formState.id
            storeStore.name = formState.name
            storeStore.logo = formState.logo
            storeStore.phone = formState.phone
            storeStore.address= formState.address
            storeStore.businessHour= formState.businessHour
            storeStore.businessLicense= formState.businessLicense
            storeStore.description= formState.description
            storeStore.packagePrice = formState.packagePrice * 100
            storeStore.type = formState.type
            open.value = false
          } else {
...
<template>
  ...
  <div id="setting">
    ...
    >
      ...
      <a-form-item ref="businessHour" label="营业时间" name="businessHour">
        <a-input v-model:value="formState.businessHour" />
      </a-form-item>
      <a-form-item ref="businessLicense" label="营业执照" name="businessLicense">
